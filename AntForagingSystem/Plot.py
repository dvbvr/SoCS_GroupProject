...
class Environment:
	...
	def AntGridFigure(fieldSize, maxFoodAmount, nestPosition):    
		...
		antsSubPlot.set_title('Environment',fontsize=32)
		...
		antsPlotFood, 	= antsSubPlot.plot(npaAgentForagingPosY,npaAgentForagingPosX, 'p', ms=7, color='orange', label='Ants foraging')
		antPlotHome, 	= antsSubPlot.plot(npaAgentForagingPosY,npaAgentForagingPosX, 'o', ms=10, color='blue', label='Ants returning home')	
		nestPlot, 		= antsSubPlot.plot(nestPosition,nestPosition, 'o', ms=30, color='black', label='Nest')	
		# Legend
		...
		antsSubPlot.legend(numpoints=1, shadow=True, bbox_to_anchor=(0,0,-0.05, 1), fontsize=25)
		...
		cbarAmountSugar.set_label('Amount of food',size=25)
		#
		plt.ion()
		plt.pause(0.0001)
